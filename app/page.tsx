...
export default function Page() {
  return (
    <div className="font-inter flex flex-row gap-10 justify-between">
        {/* Placeholder image */}
        <SkeletonImage src="https://picsum.photos/1500/1080" className="w-1/2 min-h-20" alt="placeholder image" useHtmlImg />
      <div className="flex flex-col gap-2 w-1/2 justify-end">
        <Logo size="5vw" />
        <p className="text-left font-inter h-auto w-fit mr-16 leading-normal">{placeholder}</p>
      </div>
    </div>
  );
}
